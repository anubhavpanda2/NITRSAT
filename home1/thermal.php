...
<div class="container">
        ...
        <h2>Thermal</h2>		  
       <p align="justify">
	     The thermal control system fitted to satellites is responsible for managing the operating temperatures of all components during the satellite's life span. The extreme conditions in space pose a particular challenge in this respect. On the one hand, the 
         ambient temperature in which a satellite operates may drop to absolute zero, while, on the other, temperatures may climb to extremes if it is exposed directly to the sun.
	   <p>	   
