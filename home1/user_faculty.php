	...
	<body>
		...
		<div class="navbar navbar-inverse">
			<div class="navbar-inner navbar-text">
				...
				<li class="navbar-search pull-right"><a href="change_password.php"><i class="icon-envelope icon-white"></i>Change Password</a></li>
				<!--<ul class="nav">
		...
		<div class="hero-unit">
			<div align="center">
				...
				-->
					...
					<input type="hidden"name="hidden"value="faculty"/>
					</form>
			</div>
		</div>
