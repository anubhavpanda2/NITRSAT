...
<div class="container">
        ...
        <p align="justify">	
           The design of spacecraft electronics should aim to consume less power, achieve less weight and occupy less volume. With the advent of high speed processors FPGAs, it has become possible to integrate all digital functions into a single unified integrated spacecraft electronics unit. The OBC will be built around the state of the art technologies and it will interface with TTC (RF), sensors, powers, Nano wheels and payload for command and housekeeping telemetry functions.
