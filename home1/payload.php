...
<div class="container">
		  <div class="hero-unit">
            <h2>Payload</h2>		  
           <p align="justify">	
            The objective a satellite is to study a particular or several fields on earth or other planets.  For example, the study of the ecology involves the task of acquiring images of the topology, which can be done by multiple channels such as visible channel, infra-red channel or a water vapor channel. These types of data acquisition is done by the payload in the satellite. There can be one or more than one payloads in a satellite and a satellite can also have various types of payloads. After acquiring data, they must me preprocessed for analysis. The data acquired by a satellite has to be greatly enhanced to extract data from them. Apart from this, the data must me communicated with the ground systems also. 
