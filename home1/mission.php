			...
			<div class="hero-unit">
				<div align="center">
				    <h2>Mission</h2>
					 <p align="justify">
					 <ul>
					 <li align="justify">The mission is to develop and deploy a nano-satellite and to use it for monitoring the ecology of Chotanagpur plateau in less than three years.</li></br>
					 <li align="justify">The satellite will be used for monitoring the affected area due to spreading of open cast mines. Click here to read further.</li></br> 
				     </p>  </br> 
                     </ul>					 
					<h2>Vision</h2>
	                 <p align="justify">				
                    The mission is to inspire the students to have the confidence to take up 
					the challenging task of designing a satellite and work towards it collectively. 
					This will require a collaborative research work and lot of digging. 
					The program will make NIT Rourkela a premier institute in India in the field of Space programs.					
				     </p>
				</div>
			</div>
		</div>
