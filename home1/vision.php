		...
		<div class="container">
			<div class="hero-unit">
				<div align="center">
					...
					The program will make NIT Rourkela a premier institute in India in the field of Space programs. The plan is to build a fully functional nano satellite in less than three years which would then be launched by Indian Space Research Organisation (ISRO). This is entirely a student initiative with mentorship provided by NITR Faculty.
				</div>
			</div>
		</div>
